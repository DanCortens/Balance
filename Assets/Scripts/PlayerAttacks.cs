...
public class PlayerAttacks
{
    ...
    public static Dictionary<string, Attack> SetGroundAttacks()
    {
        ...
        attacks.Add("phys",                                 //name
            new Attack(1, new float[] { 0.2f },             //swings, wind up
            .5f, new Vector2(0.5f, 0f), 1.8f,              //total anim time, pos, radius
        ...
        attacks.Add("physUp",                               //name
            ...
            0.5f, new Vector2(0f, 1f), 1.3f,                    //total anim time, pos, radius
        ...
        attacks.Add("physForward",                          //name
            ...
            0.45f, new Vector2(.8f, 0f), 1.3f,                    //total anim time, pos, radius
        ...
        attacks.Add("mag",                                  //name
            ...
            4f, "standingAttack"));                              //balance change
